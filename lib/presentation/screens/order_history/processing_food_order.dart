...
class ProcessingFoodOrderPage extends StatefulWidget {
  @override
  _ProcessingFoodOrderPageState createState() => _ProcessingFoodOrderPageState();
}

class _ProcessingFoodOrderPageState extends State<ProcessingFoodOrderPage>
                          ...
                          builder: (context, state) {
                            ...
                            if (state is FoodOrderSuccessState) {
                              ...
                              List<Orderhistory> newRequests = foodRequests
                                  .where((i) => i.accept == "1" && i.delivered == "0" && i.reject == "0").toList();
