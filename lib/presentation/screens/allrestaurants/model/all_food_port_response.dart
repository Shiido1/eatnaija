/// foodPort : [{"id":143,"rating":null,"email":"demy7275@gmail.com","email_verified_at":null,"phone":"07046700190","company_name":"D-vine Cuisine & Lounge","category":"FoodPort","image":"https://firebasestorage.googleapis.com/v0/b/fireapp-f9104.appspot.com/o/VendorLogos%2FIMGrutgBJcC?alt=media&token=71ea890e-07bc-44ed-80e1-1448691be909","address":"No.15 ,Road 45,1st Avenue, Gwarimpa","city":"Abuja","state":"FCT","verified":"1","suspend":null,"created_at":"2020-11-14T18:30:36.000000Z","updated_at":"2020-11-14T18:30:36.000000Z"},{"id":137,"rating":null,"email":"nkoyoabuja@gmail.com","email_verified_at":null,"phone":"092914917","company_name":"nkoyo","category":"FoodPort","image":"Screenshot 2020-11-13 at 11.54.02 PM_1605308526.png","address":"Ceddi Plaza Central Business District Cenral Abuja","city":"Abuja","state":"FCT","verified":"1","suspend":null,"created_at":"2020-11-13T23:02:06.000000Z","updated_at":"2020-11-13T23:39:20.000000Z"}]

class AllFoodPortResponse {
  List<FoodPort> _foodPort;

  List<FoodPort> get foodPort => _foodPort;

  AllFoodPortResponse({
    List<FoodPort> foodPort}){
    _foodPort = foodPort;
  }

  AllFoodPortResponse.fromJson(dynamic json) {
    if (json["FoodPort"] != null) {
      _foodPort = [];
      json["FoodPort"].forEach((v) {
        _foodPort.add(FoodPort.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_foodPort != null) {
      map["FoodPort"] = _foodPort.map((v) => v.toJson()).toList();
    }
    return map;
  }
}
...
class FoodPort {
  ...
  FoodPort.fromJson(dynamic json) {
    _id = json["id"];
    _rating = json["rating"];
    _email = json["email"];
