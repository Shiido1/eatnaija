/// foodEquipment : [{"id":143,"rating":null,"email":"demy7275@gmail.com","email_verified_at":null,"phone":"07046700190","company_name":"D-vine Cuisine & Lounge","category":"FoodEquipment","image":"https://firebasestorage.googleapis.com/v0/b/fireapp-f9104.appspot.com/o/VendorLogos%2FIMGrutgBJcC?alt=media&token=71ea890e-07bc-44ed-80e1-1448691be909","address":"No.15 ,Road 45,1st Avenue, Gwarimpa","city":"Abuja","state":"FCT","verified":"1","suspend":null,"created_at":"2020-11-14T18:30:36.000000Z","updated_at":"2020-11-14T18:30:36.000000Z"},{"id":137,"rating":null,"email":"nkoyoabuja@gmail.com","email_verified_at":null,"phone":"092914917","company_name":"nkoyo","category":"FoodEquipment","image":"Screenshot 2020-11-13 at 11.54.02 PM_1605308526.png","address":"Ceddi Plaza Central Business District Cenral Abuja","city":"Abuja","state":"FCT","verified":"1","suspend":null,"created_at":"2020-11-13T23:02:06.000000Z","updated_at":"2020-11-13T23:39:20.000000Z"}]

class AllFoodEquipmentResponse {
  List<FoodEquipment> _foodEquipment;

  List<FoodEquipment> get foodEquipment => _foodEquipment;

  AllFoodEquipmentResponse({
    List<FoodEquipment> foodEquipment}){
    _foodEquipment = foodEquipment;
  }

  AllFoodEquipmentResponse.fromJson(dynamic json) {
    if (json["FoodEquipment"] != null) {
      _foodEquipment = [];
      json["FoodEquipment"].forEach((v) {
        _foodEquipment.add(FoodEquipment.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_foodEquipment != null) {
      map["FoodEquipment"] = _foodEquipment.map((v) => v.toJson()).toList();
    }
    return map;
  }
...
class FoodEquipment {
  ...
  FoodEquipment.fromJson(dynamic json) {
    _id = json["id"];
    _rating = json["rating"];
    _email = json["email"];
