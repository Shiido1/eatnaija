...
class AllWellnessResponse {
  ...
  AllWellnessResponse.fromJson(dynamic json) {
    if (json["cafe"] != null) {
      _cafe = [];
      json["cafe"].forEach((v) {
        _cafe.add(Wellness.fromJson(v));
      });
    }
  }
