...
class AllCafeResponse {
  ...
  AllCafeResponse.fromJson(dynamic json) {
    if (json["cafe"] != null) {
      _cafe = [];
      json["cafe"].forEach((v) {
        _cafe.add(Cafe.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_cafe != null) {
      map["cafe"] = _cafe.map((v) => v.toJson()).toList();
    }
    return map;
  }
